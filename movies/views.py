    ...
    if request.method == 'POST':
        ...
        try:
            ...
            messages.success(request, 'Updated movie: {}'.format(response['fields'].get('Name')))
                ...
                message.warning(request, 'Get an error when trying to update a movie: {}'.format(e))
...
def delete(request, movie_id):
    try:
        ...
        messages.warning(request, 'Got an error when tying to delete a movie: {}'.format(e))
    return redirect('/')
